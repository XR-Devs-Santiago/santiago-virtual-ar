...
public class HistoriasManager : MonoBehaviour
{
	...
	//variable para el botón de personajes
	public GameObject boton_personajes;
	...
	public void activar_historia()
	{
		...
		GlobalValues.desactivar_hijos(panel_historia_content.transform);
		//buscamos el modelo seleccionado
		var modelo_seleccionado = GlobalValues.modelo_seleccionado;
		//activamos la historia de acuerdo al modelo seleccionado
	...
	{
		panel_historias.SetActive(false);
	}
